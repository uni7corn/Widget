...
public class NewtonCradleLoading extends LinearLayout {
    ...
    private CradleBallView cradleBallOne;

    private CradleBallView cradleBallTwo;

    private CradleBallView cradleBallThree;

    private CradleBallView cradleBallFour;

    private CradleBallView cradleBallFive;
    ...
    protected void onFinishInflate() {
        ...
        cradleBallOne = (CradleBallView) findViewById(R.id.ball_one);

        cradleBallTwo = (CradleBallView) findViewById(R.id.ball_two);

        cradleBallThree = (CradleBallView) findViewById(R.id.ball_three);

        cradleBallFour = (CradleBallView) findViewById(R.id.ball_four);

        cradleBallFive = (CradleBallView) findViewById(R.id.ball_five);
